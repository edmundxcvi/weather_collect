...
class WeatherObservation(Base):
    ...
    variable: Mapped[str] 
    value: Mapped[float] 
    weather_station: Mapped["WeatherStation"] = relationship(back_populates="weather_observations")
...
class WeatherStation(Base):
    ...
    name: Mapped[str] 
    weather_observations: Mapped[List["WeatherObservation"]] = relationship(back_populates="weather_station")
